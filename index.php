...
<nav class="navbar navbar-light bg-dark fixed-top">
  <div class="container-fluid">
      ...
      <!--Username-->
      <a class="navbar-brand my-auto text-primary " href="signup.php"><?php session_start(); if ((isset($_SESSION["user"]))) {echo $_SESSION["user"];} else {echo "Login/Sign Up";}?></span></a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-50" src="Promos/Ad1.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="Promos/ts.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="Promos/gh.png" alt="Third slide">
    </div>
  </div>
        ...
        while($row = mysqli_fetch_array($result)){
          if ($row['Sale Tag']=="Yes"){
              ...
              if ($row['Sale Tag']=="Yes"){
                ...
                echo '<small class="text-mmuted"><strike>$' . $row['Price'] . '</strike> <b>$' . $Price.'</b></small>';
              } else { //No Sale Price
